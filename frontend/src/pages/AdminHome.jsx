            ...
            <div className="p-6 max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-sm">Create, update, delete restaurants and manage their menus.</p>
                    </div>
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-sm">View all orders, filter by customer or restaurant, and update status.</p>
                    </div>
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-sm">Manage deliveries and update their status.</p>
                    </div>
                </div>
            </div>
        </AdminLayout>
